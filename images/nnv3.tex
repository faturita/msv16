...
\pic[shift={(0,0,0)}] at (0,0,0) {RightBandedBox={name=cr1,caption=conv1,%
        xlabel={{"8",""}},ylabel=150,zlabel=150,fill=\ConvColor,bandfill=\ConvReluColor,%
        height=40,width={6},depth=40}};
%pool1
...
%%%%%%%%%%
% fc5
\pic[shift={(3,0,0)}] at (p4-east) {RightBandedBox={name=fc5,caption=fc5,%
        xlabel={{"1",""}},zlabel=46208,fill=\FcColor,bandfill=\FcReluColor,%
        height=3,width=3,depth=100}};
%%%%%%%%%%
% fc6
\pic[shift={(2,0,0)}] at (fc5-east) {RightBandedBox={name=fc6,caption=fc6,%
        xlabel={{"1","dummy"}},zlabel=512,fill=\FcColor,bandfill=\FcReluColor,%
        height=3,width=3,depth=25}};

%%%%%%%%%%
% fc7
\pic[shift={(2,0,0)}] at (fc6-east) {RightBandedBox={name=fc7,caption=fc7  + sigmoid,%
        xlabel={{"1","dummy"}},zlabel=256,fill=\FcColor,bandfill=\FcReluColor,%
        height=3,width=3,depth=13}};
%%%%%%%%%%
% sigmoid
\pic[shift={(0,0,0)}] at (fc7-east) {Box={name=sigmoid,%
...
\draw [connection]  (p4-east)        -- node {\midarrow} (fc5-west);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\draw[densely dashed]
    (fc5-west)++(0, 1.5*.2, 1.5*.2) coordinate(a) -- (p4-nearnortheast)
    (fc5-west)++(0,-1.5*.2, 1.5*.2) coordinate(b) -- (p4-nearsoutheast)
    (fc5-west)++(0,-1.5*.2,-1.5*.2) coordinate(c) -- (p4-farsoutheast)
    (fc5-west)++(0, 1.5*.2,-1.5*.2) coordinate(d) -- (p4-farnortheast)
